"""
Django settings for CodeAlpha_RealTimeCommunicationApp project.
...
# Security settings
ALLOWED_HOSTS = ['talkbits-6167c4d2b0ba.herokuapp.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'CodeAlpha_RealTimeCommunicationApp.wsgi.application'
